...
local timerCombatStart			= mod:NewTimer(90.7, "TimerCombatStart", 2457)--rollplay for first pull
...
local timerFlameCD				= mod:NewCDTimer(28, 68125)
...
function mod:OnCombatStart(delay)
	...
	timerVolcanoCD:Start(90-delay)
	warnVolcanoSoon:Schedule(85-delay)
